...
def reconerr(args):
    ...
    normsum = K.sum(x_decoded_mean)
    scaled_x_decoded_mean = tf.map_fn(lambda x : x/normsum, x_decoded_mean)
    scaled_x_decoded_mean = tf.add(x_decoded_mean,1E-4)
...
def get_dataset(file_path, **kwargs):
    ...
    x_train = df.loc[:, 'apk_accept':'apk_writev']
...
def plot_ad_calllog_results(models, mse,
                 data,
                 batch_size,
                 model_name="vae_mlp_for_ad_calllog"):
...
if __name__ == '__main__':
    ...
    if topology == 1:
        ...
        encoder.summary()
        #plot_model(encoder, to_file='vae_mlp_for_ad_calllog_encoder_config1.png', show_shapes=True)
        ...
        decoder.summary()
        #plot_model(decoder, to_file='vae_mlp_for_ad_calllog_decoder_config1.png', show_shapes=True)
        ...
        encoder = Model(inputs, [z_mean, z_log_var, z], name='encoder') 
        encoder.summary()
        #plot_model(encoder, to_file='vae_mlp_for_ad_calllog_encoder_config.png', show_shapes=True)
        ...
        decoder = Model([inputs,latent_inputs],[x_mean, x_log_var, x_recon_err, x_recon_prob], name='decoder') 
        decoder.summary()
        #plot_model(decoder, to_file='vae_mlp_for_ad_calllog_decoder_config2.png', show_shapes=True)
        ...
        encoder = Model(inputs, [z_mean, z_log_var, z], name='encoder') 
        encoder.summary()
        #plot_model(encoder, to_file='vae_mlp_for_ad_calllog_encoder_config3.png', show_shapes=True)
        ...
        decoder = Model([inputs,latent_inputs],[x_mean, x_log_var, x_recon_err, x_recon_prob], name='decoder') 
        decoder.summary()
        #plot_model(decoder, to_file='vae_mlp_for_ad_calllog_decoder_config3.png', show_shapes=True)

    # instantiate VAE model
    [x_mean, x_log_var, x_recon_err, x_recon_prob] = decoder([inputs,encoder(inputs)[2]]) 
    vae = Model(inputs, [x_mean, x_log_var, x_recon_prob], name='vae_mlp_for_ad_calllog')
    ...
    if args.weights:
        ...
        plot_ad_calllog_results(models, args.mse, data, batch_size=batch_size, model_name="vae_mlp_for_ad_calllog"+postfix+cpostfix)
        if(topology == 3):
            print(topology)
            vis_latent(models, data, batch_size=batch_size, model_name="vae_mlp_for_ad_calllog"+postfix+cpostfix)
        ...
        if mseflag:
            os.makedirs('vae_mlp_for_ad_calllog_mse_conf'+str(topology), exist_ok=True)
            vae.save_weights('vae_mlp_for_ad_calllog_mse_conf'+str(topology)+'/vae_mlp_for_ad_calllog_mse_conf'+str(topology)+'.h5')
            plot_model(encoder, to_file='vae_mlp_for_ad_calllog_mse_conf'+str(topology)+'/vae_mlp_for_ad_calllog_encoder_config'+str(topology)+'.png', show_shapes=True)
            plot_model(decoder, to_file='vae_mlp_for_ad_calllog_mse_conf'+str(topology)+'/vae_mlp_for_ad_calllog_decoder_config'+str(topology)+'.png', show_shapes=True)
        else:
            os.makedirs('vae_mlp_for_ad_calllog_nll_conf'+str(topology), exist_ok=True)
            vae.save_weights('vae_mlp_for_ad_calllog_nll_conf'+str(topology)+'/vae_mlp_for_ad_calllog_nll_conf'+str(topology)+'.h5')
            plot_model(encoder, to_file='vae_mlp_for_ad_calllog_nll_conf'+str(topology)+'/vae_mlp_for_ad_calllog_encoder_config'+str(topology)+'.png', show_shapes=True)
            plot_model(decoder, to_file='vae_mlp_for_ad_calllog_nll_conf'+str(topology)+'/vae_mlp_for_ad_calllog_decoder_config'+str(topology)+'.png', show_shapes=True)
